<?php
    ...
    class Fornecedor extends Model{
        ...
        public function save(){
            ...
            $results = $sql->select("CALL sp_fornecedores_save(:idfornecedor,:nome_razao_social,:apelido_nome_fantasia,:cpf_cnpj,:logradouro,:numero,:complemento,:cep,:bairro,:cidade,:uf,:email,:telefone_fixo,:telefone_celular,:tipo,:pessoa_contato,:obs,:data_registro)", 
            array(
