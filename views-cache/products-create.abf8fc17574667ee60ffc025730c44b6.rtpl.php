        ...
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="vlwidth" name="vlwidth" placeholder="0.00mts">
            </div>
            <div class="form-group">
              <label for="vlheight">Altura</label>
              <input type="text" class="form-control" id="vlheight" name="vlheight" placeholder="0.00mts">
            </div>
            <div class="form-group">
              <label for="vllength">Comprimento</label>
              <input type="text" class="form-control" id="vllength" name="vllength" placeholder="0.00mts">
            </div>
            <div class="form-group">
