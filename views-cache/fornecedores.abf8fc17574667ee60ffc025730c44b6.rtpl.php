  	...
  	<div class="col-md-12">
  		<div class="box box-primary">
            ...
            <div class="box-header">
              <a href="/admin/fornecedores/create" class="btn btn-success">Cadastrar Fornecedores</a>
            </div>
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo htmlspecialchars( $value1["idfornecedor"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    ...
                    <td>
                      <a href="/admin/fornecedores/<?php echo htmlspecialchars( $value1["idfornecedor"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                      <a href="/admin/fornecedores/<?php echo htmlspecialchars( $value1["idfornecedor"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                  </tr>
                  <?php } ?>
